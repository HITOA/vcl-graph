...
VCLG::CodeGenEntrypoint::CodeGenEntrypoint(CodeGenGraph& cgg) : cgg{ cgg }, function{}, builder{ cgg.GetLLVMContext() } {}
...
void VCLG::CodeGenEntrypoint::Begin() {
    ...
    function = llvm::cast<llvm::Function>(cgg.GetLLVMModule().getOrInsertFunction("Main", functionType).getCallee());
